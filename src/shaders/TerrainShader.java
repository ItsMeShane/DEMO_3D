...
public class TerrainShader extends ShaderProgram{
    ...
    private static final String VERTEX_FILE = "shaders/glsl/terrainVertexShader.glsl";
    private static final String FRAGMENT_FILE = "shaders/glsl/terrainFragmentShader.glsl";
...
//        location_lightColor = super.getUniformLocation("lightColor");
    ...
    public void loadClipPlane(Vector4f vector4f) {
        super.loadVector(location_plane, vector4f);
    }
