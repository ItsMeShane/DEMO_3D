...
public class TerrainRenderer implements Serializable {
    ...
    private void bindTextures(Terrain terrain) {
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, texturePack.R_Texture().textureID());
        GL13.glActiveTexture(GL13.GL_TEXTURE2);
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, texturePack.G_Texture().textureID());
        GL13.glActiveTexture(GL13.GL_TEXTURE3);
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, texturePack.B_Texture().textureID());
